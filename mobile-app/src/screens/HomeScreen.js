...
const styles = StyleSheet.create({
  ...
  card:             { backgroundColor: C.card, borderRadius: 14,
                      ...
                      shadowRadius: 8, shadowOffset: { width: 0, height: 2 } },
  cardThumb:        { width: 90, backgroundColor: C.light,
                      justifyContent: 'center', alignItems: 'center' },
  thumb:            { width: 90, height: '100%', resizeMode: 'cover' },
  thumbEmoji:       { fontSize: 28 },
  offlineBadge:     { position: 'absolute', bottom: 4, left: 0, right: 0,
                      backgroundColor: C.primary + 'DD',
                      paddingVertical: 2, alignItems: 'center' },
  offlineBadgeText: { color: '#FFF', fontSize: 10, fontWeight: '600' },
